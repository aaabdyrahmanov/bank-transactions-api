...
module.exports = {
  ...
  AMQP_EXCHANGE: process.env.AMQP_EXCHANGE_NAME || 'sync.central_bank',
  AMQP_QUEUE: process.env.AMQP_QUEUE_NAME || "sync.init.central_bank",
  AMQP_ROUTING_KEY: process.env.AMQP_ROUTING_KEY || "sync_routing_key",
  EMAIL: {
